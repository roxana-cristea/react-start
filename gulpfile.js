...
const processRobotsTXT = function () {
...
const processAssets = function (cb) {
	return gulp.src(app + 'assets/**/*.{png,jpg,jpeg,gif,ico,svg,mp3,mp4}')
		.pipe($.size({ title: 'assets' }))
		.pipe(gulp.dest(dist + 'assets/'));
};
const doLint = function () {
